...
export enum EventName {
  ...
  OpenedTuningIndividual = "opened_tuning_individual",
  ...
  // SendFeedback = "send_feedback", // mailto prepopulated message & subject
}
...
export type CustomEventProperties = {
  ...
  custom_tuning?: string | undefined;
...
// whats actually relevant to know - past setup /
